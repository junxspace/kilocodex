import { sourceVersion } from "../kilocode/version" // kilocode_change
...
export const InstallationVersion = typeof KILO_VERSION === "string" ? KILO_VERSION : sourceVersion() // kilocode_change
